...
const NewStickers = ({ stickersLots }) => {
    ...
    const getFilteredStickers = () => {
        switch (selectedButton) {
            case 1:
                return stickersLots.filter((sticker) => sticker.id >= 1 && sticker.id <= 3);
            case 2:
                return stickersLots.filter((sticker) => sticker.id >= 4 && sticker.id <= 5);
            case 3:
                return stickersLots.filter((sticker) => sticker.id >= 6 && sticker.id <= 8);
            case 4:
